...
- Рефакторинг: в конструктор com.urise.model.Resume добавить второй параметр `fullName`
- Сделать рефакторинг всех реализаций `Storage`: заменить метод `com.urise.model.Resume[] getAll()` на `List<com.urise.model.Resume> getAllSorted()`
